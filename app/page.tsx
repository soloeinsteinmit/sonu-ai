...
export default function Home() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-white to-green-50 relative overflow-hidden">
      ...
      <section className="relative min-h-screen flex items-center justify-center pt-20 overflow-hidden">
        ...
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute top-32 left-16 animate-bounce delay-100">
            <div className="w-16 h-16 bg-gradient-to-br from-green-400/20 to-emerald-500/30 rounded-2xl backdrop-blur-sm flex items-center justify-center text-2xl">
              🌾
            </div>
          </div>
          <div className="absolute top-48 right-20 animate-bounce delay-300">
            <div className="w-12 h-12 bg-gradient-to-br from-amber-400/20 to-yellow-500/30 rounded-xl backdrop-blur-sm flex items-center justify-center text-xl">
              🌽
            </div>
          </div>
          <div className="absolute bottom-48 left-24 animate-bounce delay-500">
            <div className="w-14 h-14 bg-gradient-to-br from-red-400/20 to-rose-500/30 rounded-2xl backdrop-blur-sm flex items-center justify-center text-xl">
              🍅
            </div>
          </div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="text-center">
            ...
            <p className="text-xl sm:text-2xl text-gray-600 max-w-4xl mx-auto mb-12 leading-relaxed font-medium">
              ...
              and see what's happening on other farms near you.
            </p>
      ...
      <section
        id="how-it-works"
        className="py-32 bg-gradient-to-br from-slate-50 via-white to-green-50 relative overflow-hidden"
      >
        {/* Background Elements */}
        <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            ...
            <p className="text-xl sm:text-2xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              No complicated setup. Just point, shoot, and get answers about
              your crops.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 lg:gap-16">
            ...
            <div className="group text-center relative">
              ...
              <p className="text-gray-600 leading-relaxed text-lg">
                Point your phone at any leaf or plant that looks sick. The app
                works with{" "}
                <span className="font-semibold text-green-600">
                  cassava, maize, tomato, and cashew
                </span>{" "}
                crops.
              </p>
            </div>
            ...
            <div className="group text-center relative">
              ...
              <p className="text-gray-600 leading-relaxed text-lg">
                ...
                checks your photo and tells you exactly what disease (if any) is
            ...
            <div className="group text-center relative">
              ...
              <p className="text-gray-600 leading-relaxed text-lg">
                Get simple, step-by-step instructions on how to treat the
                problem. Includes both{" "}
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            ...
            <p className="text-xl sm:text-2xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
              We understand the challenges you face. That's why every feature is
              designed with{" "}
              <span className="font-semibold text-green-600">
                Ghanaian farmers
              </span>{" "}
            ...
            <div className="group flex items-start space-x-6 p-8 rounded-3xl bg-white/60 backdrop-blur-sm border border-white/20 shadow-lg hover:shadow-2xl transition-all duration-500 hover:-translate-y-2">
              ...
              <div>
                ...
                <p className="text-gray-600 leading-relaxed text-lg">
                  ...
                  the app works completely{" "}
                  <span className="font-semibold text-green-600">
                    offline in remote farming areas
                  </span>
                  .
                </p>
            ...
            <div className="group flex items-start space-x-6 p-8 rounded-3xl bg-white/60 backdrop-blur-sm border border-white/20 shadow-lg hover:shadow-2xl transition-all duration-500 hover:-translate-y-2">
              ...
              <div>
                ...
                <p className="text-gray-600 leading-relaxed text-lg">
                  ...
                  locally, plus{" "}
                  <span className="font-semibold text-amber-600">
                    organic alternatives to expensive chemicals
                  </span>
                  .
                </p>
      ...
      <section className="py-32 bg-gradient-to-br from-green-600 via-emerald-600 to-green-700 relative overflow-hidden">
        ...
        <div className="absolute inset-0 pointer-events-none opacity-20">
          <div className="absolute top-16 left-16 animate-bounce delay-100">
            <div className="w-12 h-12 bg-white/20 rounded-2xl backdrop-blur-sm flex items-center justify-center text-2xl">
              🌾
            </div>
          </div>
          <div className="absolute top-32 right-24 animate-bounce delay-300">
            <div className="w-10 h-10 bg-white/20 rounded-xl backdrop-blur-sm flex items-center justify-center text-xl">
              🌽
            </div>
          </div>
          <div className="absolute bottom-32 left-24 animate-bounce delay-500">
            <div className="w-14 h-14 bg-white/20 rounded-2xl backdrop-blur-sm flex items-center justify-center text-2xl">
              🍅
            </div>
          </div>
          ...
          <div className="grid lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-1">
              ...
              <p className="text-gray-300 mb-8 text-lg leading-relaxed">
                Empowering Ghanaian farmers with{" "}
